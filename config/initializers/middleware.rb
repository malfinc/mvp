Blank::Application.config.middleware.tap do |middleware|
  middleware.insert_before(Warden::Manager, ActionDispatch::Cookies)
  middleware.insert_before(Warden::Manager, ActionDispatch::Session::CookieStore, :key => "_blank_session", :expire_after => 14.days)
